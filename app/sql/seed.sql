...
VALUES
  ('DevTool Pro', 'The ultimate developer toolkit', 'Comprehensive development suite', 'Easy integration with existing workflow', '/icons/devtool.png', 'https://devtool.pro', '{"views": 0, "reviews": 0}', 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 1, NOW(), NOW()),
  ('DesignMaster', 'Design like a pro', 'Professional design platform', 'Intuitive interface for designers', '/icons/design.png', 'https://designmaster.app', '{"views": 0, "reviews": 0}', 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 2, NOW(), NOW()),
  ('MarketGenius', 'Smart marketing automation', 'AI-powered marketing platform', 'Automated marketing workflows', '/icons/market.png', 'https://marketgenius.io', '{"views": 0, "reviews": 0}', 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 3, NOW(), NOW()),
  ('CodeBuddy', 'Your coding companion', 'AI pair programming assistant', 'Real-time code suggestions', '/icons/code.png', 'https://codebuddy.dev', '{"views": 0, "reviews": 0}', 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 4, NOW(), NOW()),
  ('DataViz', 'Beautiful data visualization', 'Turn data into insights', 'Drag-and-drop visualization builder', '/icons/dataviz.png', 'https://dataviz.app', '{"views": 0, "reviews": 0}', 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 5, NOW(), NOW());

-- Seed product upvotes (bridge table)
INSERT INTO product_upvotes (product_id, profile_id)
VALUES (1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec');

-- Seed reviews
INSERT INTO reviews (product_id, profile_id, rating, review, created_at, updated_at)
VALUES
  (1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 5, 'Excellent developer tool!', NOW(), NOW()),
  (2, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 4, 'Great design features', NOW(), NOW()),
  (3, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 5, 'Amazing marketing automation', NOW(), NOW()),
  (4, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 4, 'Very helpful coding assistant', NOW(), NOW()),
  (5, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 5, 'Powerful visualization tool', NOW(), NOW());
...
VALUES
  ('Getting Started with DevTool Pro', 'A comprehensive guide to DevTool Pro...', 1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NOW(), NOW()),
  ('Design Tips and Tricks', 'Essential design principles...', 2, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NOW(), NOW()),
  ('Marketing Automation Best Practices', 'How to automate your marketing...', 3, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NOW(), NOW()),
  ('Launching Your First Product', 'Steps to a successful product launch...', 4, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NOW(), NOW()),
  ('AI in Modern Development', 'How AI is changing development...', 5, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NOW(), NOW());
...
VALUES
  (1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'Great post about DevTool Pro!', NOW(), NOW()),
  (2, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'These design tips are very helpful', NOW(), NOW()),
  (3, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'Marketing automation is crucial', NOW(), NOW()),
  (4, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'Launch strategy is on point', NOW(), NOW()),
  (5, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'AI is indeed transforming development', NOW(), NOW());

-- Seed gpt ideas
INSERT INTO gpt_ideas (idea, views, claimed_by, created_at)
VALUES
  ('AI-powered code review assistant', 0, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NOW()),
...
VALUES
  ...
  ('MarketGenius', 4, 25, 'launched', 'Marketing, Sales, Developer, Designer', 'Marketing analytics platform', NOW(), NOW()),
...
VALUES (1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NOW());

-- Seed messages
INSERT INTO messages (message_room_id, sender_id, content, created_at)
VALUES
  (1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'Hello! Interested in collaboration', NOW()),
  (1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'Let''s discuss the project details', NOW()),
  (1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'What''s your availability?', NOW()),
  (1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'I can start next week', NOW()),
  (1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'Great, looking forward to working together', NOW());

-- Seed notifications
INSERT INTO notifications (source_id, product_id, post_id, target_id, type, created_at)
VALUES
  ('e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 1, NULL, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'review', NOW()),
  ('e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NULL, 1, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'reply', NOW()),
  ('e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NULL, NULL, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'follow', NOW()),
  ('e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', NULL, 2, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'mention', NOW()),
  ('e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 2, NULL, 'e0e3c4b7-01e1-4dc0-8fac-3860c285a3ec', 'review', NOW());
