...
--> statement-breakpoint
ALTER TABLE "product_upvote" RENAME TO "product_upvotes";--> statement-breakpoint
ALTER TABLE "product_upvotes" DROP CONSTRAINT "product_upvote_product_id_products_product_id_fk";
--> statement-breakpoint
ALTER TABLE "product_upvotes" DROP CONSTRAINT "product_upvote_profile_id_profiles_profile_id_fk";
--> statement-breakpoint
ALTER TABLE "product_upvotes" DROP CONSTRAINT "product_upvote_product_id_profile_id_pk";--> statement-breakpoint
ALTER TABLE "product_upvotes" ADD CONSTRAINT "product_upvotes_product_id_profile_id_pk" PRIMARY KEY("product_id","profile_id");--> statement-breakpoint
...
ALTER TABLE "post_replies" ADD CONSTRAINT "post_replies_parent_id_post_replies_post_reply_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."post_replies"("post_reply_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
