...
CREATE TABLE "product_upvote" (
	"product_id" bigint,
	"profile_id" uuid,
	CONSTRAINT "product_upvote_product_id_profile_id_pk" PRIMARY KEY("product_id","profile_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "product_upvote" ADD CONSTRAINT "product_upvote_product_id_products_product_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("product_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_upvote" ADD CONSTRAINT "product_upvote_profile_id_profiles_profile_id_fk" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("profile_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
